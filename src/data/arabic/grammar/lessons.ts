...
export const grammarLessons: GrammarLesson[] = [
  // LESSON 1: The Arabic Alphabet Overview
  {
    ...
    titleArabic: 'نِظَامُ الْكِتَابَةِ الْعَرَبِيَّةِ',
    ...
    content: [
      ...
      },
      {
        ...
        examples: [
          ...
          { arabic: 'قُفْل', english: 'lock', french: 'serrure' },
      ...
      },
      {
        ...
        examples: [
          ...
          { arabic: 'سُوق', english: 'market', french: 'marché' },
          { arabic: 'رُوح', english: 'soul', french: 'âme' },
  ...
  // LESSON 3: The Definite Article
  {
    ...
    titleArabic: 'أَدَاةُ التَّعْرِيفِ',
  ...
  // LESSON: Indefinite Articles & Tanween
  {
    ...
    titleArabic: 'النَّكِرَة وَالتَّنْوِينُ',
  ...
  // LESSON 4: Personal Pronouns
  {
    ...
    content: [
      ...
      },
      {
        ...
        arabicDescription: 'أَنَا لِلْمُذَكَّرِ وَالْمُؤَنَّث',
  ...
  // LESSON 5: Noun Gender
  {
    ...
    titleArabic: 'الْمُذَكَّر وَالْمُؤَنَّثُ',
    ...
    content: [
      ...
      },
      {
        ...
        examples: [
          ...
          { arabic: 'أَنَا مُتْعَبَةٌ', english: 'I am tired (f)', french: 'Je suis fatigu\u00e9e (f)' },
  ...
  // LESSON 7: Question Words
  {
    ...
    titleArabic: 'أَدَوَات الاِسْتِفْهَامُ',
  ...
  // LESSON 8: Demonstrative Pronouns
  {
    ...
    titleArabic: 'أَسْمَاء الْإِشَارَةُ',
  ...
  // LESSON 12: Numbers with Nouns
  {
    ...
    titleArabic: 'الْأَعْدَاد مَعَ الْأَسْمَاءُ',
  ...
  // LESSON 13: Verbal Sentences
  {
    ...
    titleArabic: 'الْجُمْلَة الْفِعْلِيَّةُ',
    ...
    content: [
      ...
      },
      {
        ...
        examples: [
          ...
          { arabic: 'وَصَلَتِ الطَّائِرَةُ', english: 'The plane arrived', french: 'L\'avion est arrivé' },
  ...
  // LESSON 17: Idafa Construction
  {
    ...
    content: [
...

      {
        ...
        arabicDescription: 'الْإِضَافَة أَسَاسِيَّة جِدًّا فِي الْعَرَبِيَّةِ',
  ...
  // LESSON 19: Dual Form
  {
    ...
    content: [
      ...
      },
      {
        ...
        arabicDescription: 'هُمَا وَأَنْتُمَا لِلْمُذَكَّرِ وَالْمُؤَنَّث',
  ...
  // LESSON 20: Object Pronouns
  {
    ...
    titleArabic: 'الضَّمَائِر الْمُتَّصِلَةُ',
  ...
  // LESSON 23: Relative Pronouns
  {
    ...
    titleArabic: 'الْأَسْمَاء الْمَوْصُولَةُ',
    ...
    content: [
      ...
      },
      {
        ...
        arabicDescription: 'الَّذِي لِلْمُذَكَّرِ، الَّتِي لِلْمُؤَنَّثِ',
  ...
  // LESSON 25: Comparative & Superlative
  {
    ...
    titleArabic: 'أَفْعَل التَّفْضِيلُ',
    ...
    content: [
      ...
      },
      {
        ...
        examples: [
          { arabic: 'أَحْمَدُ أَكْبَرُ مِنْ عَلِيٍّ', english: 'Ahmad is bigger than Ali', french: 'Ahmad est plus grand qu\'Ali' },
      ...
      },
      {
        ...
        arabicDescription: 'أَفْعَل التَّفْضِيل لَا يَتَغَيَّر لِلْمُذَكَّرِ وَالْمُؤَنَّث',
  ...
  // LESSON 27: Passive Participles
  {
    ...
    titleArabic: 'اِسْم الْمَفْعُولُ',
    ...
    content: [
      ...
      },
      {
        ...
        examples: [
          ...
          { arabic: 'الْكِتَاب مَكْتُوب بِالْعَرَبِيَّةِ', english: 'The book is written in Arabic', french: 'Le livre est écrit en arabe' },
    ...
    content: [
      ...
      },
      {
        ...
        examples: [
          ...
          { arabic: 'شَاهَدَ ← مُشَاهَدَة', english: 'watched → watching (Form III)', french: 'a voyagé → voyage (Forme III)' },
  ...
  // LESSON 29: Introduction to Verb Patterns
  {
    ...
    titleArabic: 'مُقَدِّمَة فِي الْأَوْزَانِ',
  ...
  // LESSON 30: Conditional Sentences
  {
    ...
    titleArabic: 'الْجُمْلَة الشَّرْطِيَّةُ',
  ...
  // LESSON 34: The Passive Voice
  {
    ...
    titleArabic: 'الْمَبْنِيّ لِلْمَجْهُولُ',
  ...
  // LESSON 35: Verb Forms II-IV
  {
    ...
    titleArabic: 'الْأَوْزَانُ II-III-IV',
    ...
    content: [
      ...
      },
      {
        ...
        examples: [
          ...
          { arabic: 'سَلِمَ ← أَسْلَمَ', english: 'was safe → submitted (to Islam)', french: 'était sauf → s\'est soumis (à l\'Islam)' },
  ...
  // LESSON 36: Verb Forms V-VII
  {
    ...
    titleArabic: 'الْأَوْزَانُ V-VI-VII',
  ...
  // LESSON 37: Verb Forms VIII-X
  {
    ...
    titleArabic: 'الْأَوْزَانُ VIII-IX-X',
    ...
    content: [
      ...
      },
      {
        ...
        examples: [
          ...
          { arabic: 'قَرُبَ ← اِقْتَرَبَ', english: 'was near → approached', french: 'était proche → s\'est approché' },
      ...
      },
      {
        ...
        examples: [
          ...
          { arabic: 'عَمِلَ ← اِسْتَعْمَلَ', english: 'worked → used, employed', french: 'a travaillé → a utilisé, a employé' },
          { arabic: 'خَرَجَ ← اِسْتَخْرَجَ', english: 'went out → extracted', french: 'est sorti → a extrait' },
  ...
  // LESSON 38: Adverbs & Adverbial Expressions
  {
    ...
    titleArabic: 'الظُّرُوف وَالْأَحْوَالُ',
  ...
  // LESSON 40: Complex Sentences & Emphasis
  {
    ...
    titleArabic: 'الْجُمَل الْمُرَكَّبَة وَالتَّوْكِيدُ',
