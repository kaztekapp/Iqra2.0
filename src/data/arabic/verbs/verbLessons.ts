...
export const verbLessons: GrammarLesson[] = [
  // LESSON 1: Introduction to Arabic Verbs
  {
    ...
    titleArabic: 'مُقَدِّمَة الأَفْعَال الْعَرَبِيَّةُ',
  ...
  // LESSON 2: Past Tense Patterns
  {
    ...
    titleArabic: 'الْفِعْل الْمَاضِيُ',
  ...
  // LESSON 3: Present Tense Patterns
  {
    ...
    titleArabic: 'الْفِعْل الْمُضَارِعُ',
  ...
  // LESSON 4: Future Tense
  {
    ...
    titleArabic: 'الْفِعْل الْمُسْتَقْبَلُ',
  ...
  // LESSON 6: Verb Forms Overview
  {
    ...
    titleArabic: 'أَوْزَان الْفِعْل الْعَرَبِيُ',
