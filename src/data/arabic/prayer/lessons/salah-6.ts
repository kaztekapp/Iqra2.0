...
export const salah6Content: PrayerContent[] = [
  {
    ...
    titleArabic: 'مَا هُوَ سُجُودُ السَّهْوِ؟',
  ...
  },
  {
    ...
    titleArabic: 'الْأَسْبَابُ الثَّلَاثَةُ',
    steps: [
      {
        stepNumber: 1,
        title: 'Addition (Ziyadah)',
        titleFr: 'Ajout (Ziyadah)',
        titleArabic: 'الزِّيَادَةُ',
  ...
  },
  {
    ...
    titleArabic: 'قَبْلَ أَمْ بَعْدَ التَّسْلِيمِ؟',
  ...
  },
  {
    ...
    title: 'Key Terms',
    titleFr: 'Termes cles',
    titleArabic: 'مُصْطَلَحَاتٌ مُهِمَّةٌ',
    examples: [
      {
        arabic: 'سُجُودُ السَّهْوِ',
