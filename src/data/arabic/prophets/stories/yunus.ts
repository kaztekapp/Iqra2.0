...
export const yunusStoryContent: StoryContentBlock[] = [
  ...
  // ============ PART 1: THE SHIP, AND THE FISH ============
  {
    ...
    type: 'narrative',
    order: 2,
    content: "As-Saffat tells it from the ship: he ran to it, drew lots and lost, and the fish swallowed him. What would have happened had he not been one who glorified Allah; the shore; the gourd vine; and the hundred thousand who believed.",
    contentFr: "As-Saffat le raconte depuis le vaisseau : il y courut, tira au sort et perdit, et le poisson l'avala. Ce qui serait arrivé s'il n'avait pas été de ceux qui glorifient Allah ; le rivage ; le plant de courge ; et les cent mille qui crurent.",
  },
  {
    id: 'yunus-3',
    type: 'quran_source',
  ...
  },
  {
    ...
    type: 'narrative',
    order: 5,
    content: "Al-Anbiya gives the prayer he made in the darknesses, word for word, and Allah's answer - and says that this is how the believers are saved.",
    contentFr: "Al-Anbiya donne la prière qu'il fit dans les ténèbres, mot pour mot, et la réponse d'Allah - et dit que c'est ainsi que les croyants sont sauvés.",
  },
  {
    id: 'yunus-6',
    type: 'quran_source',
  ...
  },
  {
    ...
    type: 'narrative',
    order: 8,
    content: "Al-Qalam tells the Prophet ﷺ to be patient and not to be like the companion of the fish - and says what Allah did for Yunus after.",
    contentFr: "Al-Qalam dit au Prophète ﷺ de patienter et de ne pas être comme l'homme au poisson - et dit ce qu'Allah fit pour Younous ensuite.",
  },
  {
    id: 'yunus-9',
    type: 'quran_source',
  ...
  // ============ PART 4: WHAT THE PROPHET ﷺ TOLD OF HIM ============
  {
    ...
    type: 'narrative',
    order: 18,
    content: "The Prophet ﷺ forbade anyone to place himself above Yunus.",
    contentFr: "Le Prophète ﷺ interdit à quiconque de se placer au-dessus de Younous.",
  },
  {
    id: 'yunus-19',
    type: 'hadith_source',
  ...
  },
  {
    ...
    type: 'narrative',
    order: 20,
    content: "And he ﷺ told what the prayer of the belly of the fish is worth to whoever says it.",
    contentFr: "Et il ﷺ dit ce que vaut la prière du ventre du poisson pour quiconque la dit.",
  },
  {
    id: 'yunus-21',
    type: 'hadith_source',
