...
export const yunusStoryContent: StoryContentBlock[] = [
  ...
  },
  {
    ...
    source: {
      ...
      translation: "Let none of you say: I am better than Yunus. Musaddad added: Yunus ibn Matta.",
      translationFr: "Que nul d'entre vous ne dise : Je suis meilleur que Younous. Mousaddad ajouta : Younous fils de Matta.",
      grade: "sahih",
    } as HadithReference,
  },
  {
    ...
    type: 'narrative',
    order: 20,
    content: "⟨لاَ يَقُولَنَّ أَحَدُكُمْ إِنِّي خَيْرٌ مِنْ يُونُسَ .⟩ Let none of you say: I am better than Yunus.",
    contentFr: "⟨لاَ يَقُولَنَّ أَحَدُكُمْ إِنِّي خَيْرٌ مِنْ يُونُسَ .⟩ Que nul d'entre vous ne dise : Je suis meilleur que Younous.",
  },
  {
    id: 'yunus-21',
    type: 'narrative',
    order: 21,
    content: "⟨زَادَ مُسَدَّدٌ يُونُسَ بْنِ مَتَّى⟩ Musaddad added: Yunus ibn Matta.",
    contentFr: "⟨زَادَ مُسَدَّدٌ يُونُسَ بْنِ مَتَّى⟩ Mousaddad ajouta : Younous fils de Matta.",
  },
  {
    id: 'yunus-22',
    type: 'narrative',
  ...
  },
  {
    ...
    type: 'narrative',
    order: 24,
    content: "⟨دَعْوَةُ ذِي النُّونِ إِذْ دَعَا وَهُوَ فِي بَطْنِ الْحُوتِ لاَ إِلَهَ إِلاَّ أَنْتَ سُبْحَانَكَ إِنِّي كُنْتُ مِنَ الظَّالِمِينَ .⟩ The supplication of Dhun-Nun when he called out in the belly of the fish: \"There is no deity except You; exalted are You. Indeed, I have been of the wrongdoers.\"",
    contentFr: "⟨دَعْوَةُ ذِي النُّونِ إِذْ دَعَا وَهُوَ فِي بَطْنِ الْحُوتِ لاَ إِلَهَ إِلاَّ أَنْتَ سُبْحَانَكَ إِنِّي كُنْتُ مِنَ الظَّالِمِينَ .⟩ L'invocation de Dhoun-Noun quand il appela dans le ventre du poisson : « Il n'y a de dieu que Toi ; gloire à Toi. J'ai été du nombre des injustes. »",
  },
  {
    id: 'yunus-25',
    type: 'narrative',
    order: 25,
    content: "⟨فَإِنَّهُ لَمْ يَدْعُ بِهَا رَجُلٌ مُسْلِمٌ فِي شَيْءٍ قَطُّ إِلاَّ اسْتَجَابَ اللَّهُ لَهُ .⟩ No Muslim ever calls with it, for any matter, except that Allah answers him.",
    contentFr: "⟨فَإِنَّهُ لَمْ يَدْعُ بِهَا رَجُلٌ مُسْلِمٌ فِي شَيْءٍ قَطُّ إِلاَّ اسْتَجَابَ اللَّهُ لَهُ .⟩ Nul musulman ne l'invoque, pour quelque affaire que ce soit, sans qu'Allah ne l'exauce.",
  },
