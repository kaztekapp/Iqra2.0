...
export const yunusStoryContent: StoryContentBlock[] = [
  ...
  },
  {
    ...
    type: 'quran_source',
    order: 3,
    content: "Surah As-Saffat: The laden ship, the lots, the fish, the shore, the gourd vine, and the hundred thousand.",
    contentFr: "La sourate As-Saffat : Le vaisseau chargé, le tirage au sort, le poisson, le rivage, le plant de courge, et les cent mille.",
    source: {
      type: "quran",
      surahNumber: 37,
  ...
  },
  {
    ...
    type: 'quran_source',
    order: 6,
    content: "Surah Al-Anbiya: \"There is no deity except You; exalted are You. Indeed, I have been of the wrongdoers.\"",
    contentFr: "La sourate Al-Anbiya : « Il n'y a de dieu que Toi ; gloire à Toi. J'ai été du nombre des injustes. »",
    source: {
      type: "quran",
      surahNumber: 21,
  ...
  },
  {
    ...
    type: 'quran_source',
    order: 9,
    content: "Surah Al-Qalam: \"And his Lord chose him and made him of the righteous.\"",
    contentFr: "La sourate Al-Qalam : « Et son Seigneur le choisit et le mit au nombre des vertueux. »",
    source: {
      type: "quran",
      surahNumber: 68,
  ...
  },
  {
    ...
    type: 'quran_source',
    order: 12,
    content: "Surah Yunus: The only city whose faith benefited it: the people of Yunus.",
    contentFr: "La sourate Yunus : La seule cité dont la foi lui profita : le peuple de Younous.",
    source: {
      type: "quran",
      surahNumber: 10,
  ...
  // ============ PART 3: WHERE ELSE THE QURAN NAMES HIM ============
  {
    ...
    type: 'quran_source',
    order: 14,
    content: "Surah An-Nisa: Allah revealed to Yunus, as to the prophets before him.",
    contentFr: "La sourate An-Nisa : Allah a fait une révélation à Younous, comme aux prophètes avant lui.",
    source: {
      type: "quran",
      surahNumber: 4,
  ...
  },
  {
    ...
    source: {
      ...
      arabicText: "حَدَّثَنَا مُسَدَّدٌ، حَدَّثَنَا يَحْيَى، عَنْ سُفْيَانَ، قَالَ حَدَّثَنِي الأَعْمَشُ،. حَدَّثَنَا أَبُو نُعَيْمٍ، حَدَّثَنَا سُفْيَانُ، عَنِ الأَعْمَشِ، عَنْ أَبِي وَائِلٍ، عَنْ عَبْدِ اللَّهِ ـ رضى الله عنه ـ عَنِ النَّبِيِّ صلى الله عليه وسلم قَالَ لاَ يَقُولَنَّ أَحَدُكُمْ إِنِّي خَيْرٌ مِنْ يُونُسَ . زَادَ مُسَدَّدٌ يُونُسَ بْنِ مَتَّى",
