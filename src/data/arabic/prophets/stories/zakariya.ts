...
export const zakariyaStoryContent: StoryContentBlock[] = [
  ...
  },
  {
    ...
    type: 'quran_source',
    order: 3,
    content: "Surah Ali 'Imran: \"O Maryam, from where is this coming to you?\" \"It is from Allah.\"",
    contentFr: "La sourate Ali 'Imran : « Ô Maryam, d'où te vient cela ? » « Cela vient d'Allah. »",
    source: {
      type: "quran",
      surahNumber: 3,
  ...
  },
  {
    ...
    type: 'quran_source',
    order: 6,
    content: "Surah Ali 'Imran: \"My Lord, grant me from Yourself a good offspring.\" \"Allah gives you good tidings of Yahya.\"",
    contentFr: "La sourate Ali 'Imran : « Mon Seigneur, accorde-moi de Ta part une bonne descendance. » « Allah t'annonce Yahya. »",
    source: {
      type: "quran",
      surahNumber: 3,
      surahNameEnglish: "Ali 'Imran",
  ...
  },
  {
    ...
    type: 'quran_source',
    order: 9,
    content: "Surah Maryam: \"My Lord, my bones have weakened.\" \"O Zakariya, We give you good tidings of a boy whose name will be Yahya.\"",
    contentFr: "La sourate Maryam : « Mon Seigneur, mes os se sont affaiblis. » « Ô Zakariya, Nous t'annonçons un garçon dont le nom sera Yahya. »",
    source: {
      type: "quran",
      surahNumber: 19,
  ...
  },
  {
    ...
    type: 'quran_source',
    order: 12,
    content: "Surah Al-Anbiya: \"My Lord, do not leave me alone, while You are the best of inheritors.\"",
    contentFr: "La sourate Al-Anbiya : « Mon Seigneur, ne me laisse pas seul, alors que Tu es le meilleur des héritiers. »",
    source: {
      type: "quran",
      surahNumber: 21,
