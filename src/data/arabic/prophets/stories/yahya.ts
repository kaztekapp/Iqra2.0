...
export const yahyaStoryContent: StoryContentBlock[] = [
  ...
  },
  {
    ...
    type: 'quran_source',
    order: 3,
    content: "Surah Ali 'Imran: \"Allah gives you good tidings of Yahya, confirming a word from Allah.\"",
    contentFr: "La sourate Ali 'Imran : « Allah t'annonce Yahya, confirmateur d'une parole d'Allah. »",
    source: {
      type: "quran",
      surahNumber: 3,
  ...
  },
  {
    ...
    type: 'quran_source',
    order: 6,
    content: "Surah Maryam: \"We give you good tidings of a boy whose name will be Yahya. We have not assigned to any before this name.\"",
    contentFr: "La sourate Maryam : « Nous t'annonçons un garçon dont le nom sera Yahya. Nous n'avons donné ce nom à personne avant lui. »",
    source: {
      type: "quran",
      surahNumber: 19,
  ...
  },
  {
    ...
    type: 'quran_source',
    order: 9,
    content: "Surah Al-Anbiya: \"We gave to him Yahya, and amended for him his wife.\"",
    contentFr: "La sourate Al-Anbiya : « Nous lui donnâmes Yahya, et rendîmes sa femme capable d'enfanter. »",
    source: {
      type: "quran",
      surahNumber: 21,
  ...
  },
  {
    ...
    type: 'quran_source',
    order: 12,
    content: "Surah Maryam: \"O Yahya, take the Scripture with determination.\" Peace upon him the day he was born.",
    contentFr: "La sourate Maryam : « Ô Yahya, prends le Livre avec force. » Paix sur lui le jour où il naquit.",
    source: {
      type: "quran",
      surahNumber: 19,
      surahNameEnglish: "Maryam",
