...
export const ayyubStoryContent: StoryContentBlock[] = [
  ...
  },
  {
    ...
    type: 'narrative',
    order: 20,
    content: "⟨إِنَّ نَبِيَّ اللَّهِ أَيُّوبَ لَبِثَ بِهِ بَلَاؤُهُ ثَمَانِيَ عَشْرَةَ سَنَةً، فَرَفَضَهُ الْقَرِيبُ وَالْبَعِيدُ إِلَّا رَجُلَيْنِ مِنْ إِخْوَانِهِ كَانَا مِنْ أَخَصِّ إِخْوَانِهِ، كَانَا يَغْدُوَانِ إِلَيْهِ وَيَرُوحَانِ،⟩ The prophet of Allah Ayyub remained in his trial for eighteen years. The near and the far abandoned him, except two men from among his brothers who were among the closest of his brothers; they came to him in the morning and in the evening.",
    contentFr: "⟨إِنَّ نَبِيَّ اللَّهِ أَيُّوبَ لَبِثَ بِهِ بَلَاؤُهُ ثَمَانِيَ عَشْرَةَ سَنَةً، فَرَفَضَهُ الْقَرِيبُ وَالْبَعِيدُ إِلَّا رَجُلَيْنِ مِنْ إِخْوَانِهِ كَانَا مِنْ أَخَصِّ إِخْوَانِهِ، كَانَا يَغْدُوَانِ إِلَيْهِ وَيَرُوحَانِ،⟩ Le prophète d'Allah Ayyoub demeura dans son épreuve dix-huit ans. Les proches et les lointains l'abandonnèrent, sauf deux hommes parmi ses frères qui étaient des plus intimes de ses frères ; ils venaient à lui le matin et le soir.",
  },
  {
    id: 'ayyub-21',
    type: 'narrative',
    order: 21,
    content: "⟨فَقَالَ أَحَدُهُمَا لِصَاحِبِهِ: تَعْلَمُ وَاللَّهِ لَقَدْ أَذْنَبَ أَيُّوبُ ذَنْبًا مَا أَذْنَبَهُ أَحَدٌ مِنَ الْعَالَمِينَ، فَقَالَ لَهُ صَاحِبُهُ: وَمَا ذَاكَ؟ قَالَ: مُنْذُ ثَمَانِيَ عَشْرَةَ سَنَةً لَمْ يَرْحَمْهُ اللَّهُ فَيَكْشِفَ مَا بِهِ،⟩ One of them said to his companion: You know, by Allah, Ayyub has committed a sin that no one in the worlds has committed. His companion said: And what is that? He said: For eighteen years Allah has not shown him mercy and removed what is on him.",
    contentFr: "⟨فَقَالَ أَحَدُهُمَا لِصَاحِبِهِ: تَعْلَمُ وَاللَّهِ لَقَدْ أَذْنَبَ أَيُّوبُ ذَنْبًا مَا أَذْنَبَهُ أَحَدٌ مِنَ الْعَالَمِينَ، فَقَالَ لَهُ صَاحِبُهُ: وَمَا ذَاكَ؟ قَالَ: مُنْذُ ثَمَانِيَ عَشْرَةَ سَنَةً لَمْ يَرْحَمْهُ اللَّهُ فَيَكْشِفَ مَا بِهِ،⟩ L'un d'eux dit à son compagnon : Tu sais, par Allah, Ayyoub a commis un péché que personne au monde n'a commis. Son compagnon dit : Et qu'est-ce donc ? Il dit : Depuis dix-huit ans, Allah ne lui a pas fait miséricorde en ôtant ce qu'il a.",
  },
  {
    id: 'ayyub-22',
    type: 'narrative',
    order: 22,
    content: "⟨فَلَمَّا رَاحَا إِلَيْهِ لَمْ يَصْبِرِ الرَّجُلُ حَتَّى ذَكَرَ ذَلِكَ لَهُ، فَقَالَ أَيُّوبُ: لَا أَدْرِي مَا تَقُولُ، غَيْرَ أَنَّ اللَّهَ عَزَّ وَجَلَّ يَعْلَمُ أَنِّي كُنْتُ أَمُرُّ عَلَى الرَّجُلَيْنِ يَتَنَازَعَانِ فَيَذْكُرَانِ اللَّهَ، فَأَرْجِعُ إِلَى بَيْتِي فَأُكَفِّرُ عَنْهُمَا كَرَاهِيَةَ أَنْ يُذْكَرَ اللَّهُ إِلَّا فِي حَقٍّ.⟩ When they went to him in the evening, the man could not hold back until he mentioned that to him. Ayyub said: I do not know what you are saying, except that Allah knows that I used to pass by two men disputing, and they would mention Allah, and I would go back to my house and make expiation for them, hating that Allah be mentioned except in truth.",
    contentFr: "⟨فَلَمَّا رَاحَا إِلَيْهِ لَمْ يَصْبِرِ الرَّجُلُ حَتَّى ذَكَرَ ذَلِكَ لَهُ، فَقَالَ أَيُّوبُ: لَا أَدْرِي مَا تَقُولُ، غَيْرَ أَنَّ اللَّهَ عَزَّ وَجَلَّ يَعْلَمُ أَنِّي كُنْتُ أَمُرُّ عَلَى الرَّجُلَيْنِ يَتَنَازَعَانِ فَيَذْكُرَانِ اللَّهَ، فَأَرْجِعُ إِلَى بَيْتِي فَأُكَفِّرُ عَنْهُمَا كَرَاهِيَةَ أَنْ يُذْكَرَ اللَّهُ إِلَّا فِي حَقٍّ.⟩ Quand ils allèrent à lui le soir, l'homme ne put se retenir de le lui dire. Ayyoub dit : Je ne sais pas ce que tu dis, sinon qu'Allah sait que je passais près de deux hommes qui se disputaient et mentionnaient Allah, et je rentrais chez moi et faisais une expiation pour eux, détestant qu'Allah soit mentionné autrement qu'en vérité.",
  },
  {
    id: 'ayyub-23',
    type: 'narrative',
    order: 23,
    content: "⟨وَكَانَ يَخْرُجُ إِلَى حَاجَتِهِ، فَإِذَا قَضَاهَا أَمْسَكَتِ امْرَأَتُهُ بِيَدِهِ حَتَّى يَبْلُغَ، فَلَمَّا كَانَ ذَاتَ يَوْمٍ أَبْطَأَ عَلَيْهَا، وَأُوحِيَ إِلَى أَيُّوبَ فِي مَكَانِهِ أَنِ ارْكُضْ بِرِجْلِكَ هَذَا مُغْتَسَلٌ بَارِدٌ وَشَرَابٌ،⟩ He used to go out to relieve himself, and when he had finished, his wife would take him by the hand until he reached home. One day he was slow in coming back to her, and it was revealed to Ayyub where he was: Strike with your foot; this is a cool bath and a drink.",
    contentFr: "⟨وَكَانَ يَخْرُجُ إِلَى حَاجَتِهِ، فَإِذَا قَضَاهَا أَمْسَكَتِ امْرَأَتُهُ بِيَدِهِ حَتَّى يَبْلُغَ، فَلَمَّا كَانَ ذَاتَ يَوْمٍ أَبْطَأَ عَلَيْهَا، وَأُوحِيَ إِلَى أَيُّوبَ فِي مَكَانِهِ أَنِ ارْكُضْ بِرِجْلِكَ هَذَا مُغْتَسَلٌ بَارِدٌ وَشَرَابٌ،⟩ Il sortait pour faire ses besoins, et quand il avait fini, sa femme le prenait par la main jusqu'à ce qu'il arrive. Un jour, il tarda à revenir vers elle, et il fut révélé à Ayyoub là où il était : Frappe du pied ; voici un bain frais et une boisson.",
  },
  {
    id: 'ayyub-24',
    type: 'narrative',
    order: 24,
    content: "⟨فَاسْتَبْطَأَتْهُ فَتَلَقَّتْهُ تَنْظُرُ، وَأَقْبَلَ عَلَيْهَا قَدْ أَذْهَبَ اللَّهُ مَا بِهِ مِنَ الْبَلَاءِ وَهُوَ عَلَى أَحْسَنِ مَا كَانَ، فَلَمَّا رَأَتْهُ قَالَتْ: أَيْ بَارَكَ اللَّهُ فِيكَ، هَلْ رَأَيْتَ نَبِيَّ اللَّهِ هَذَا الْمُبْتَلَى؟ فَوَاللَّهِ عَلَى ذَلِكَ مَا رَأَيْتُ رَجُلًا أَشْبَهَ بِهِ مِنْكَ إِذْ كَانَ صَحِيحًا، قَالَ: فَإِنِّي أَنَا هُوَ.⟩ She thought him slow and went to meet him, looking for him, and he came toward her; Allah had taken away the trial that was on him, and he was in the best state he had ever been. When she saw him she said: May Allah bless you, have you seen the prophet of Allah, the one afflicted? By Allah, I have never seen a man who resembled him more than you, when he was well. He said: I am he.",
    contentFr: "⟨فَاسْتَبْطَأَتْهُ فَتَلَقَّتْهُ تَنْظُرُ، وَأَقْبَلَ عَلَيْهَا قَدْ أَذْهَبَ اللَّهُ مَا بِهِ مِنَ الْبَلَاءِ وَهُوَ عَلَى أَحْسَنِ مَا كَانَ، فَلَمَّا رَأَتْهُ قَالَتْ: أَيْ بَارَكَ اللَّهُ فِيكَ، هَلْ رَأَيْتَ نَبِيَّ اللَّهِ هَذَا الْمُبْتَلَى؟ فَوَاللَّهِ عَلَى ذَلِكَ مَا رَأَيْتُ رَجُلًا أَشْبَهَ بِهِ مِنْكَ إِذْ كَانَ صَحِيحًا، قَالَ: فَإِنِّي أَنَا هُوَ.⟩ Le trouvant lent, elle alla à sa rencontre, le cherchant du regard, et il vint vers elle ; Allah avait ôté l'épreuve qui était sur lui, et il était dans le meilleur état qu'il ait jamais eu. Quand elle le vit, elle dit : Qu'Allah te bénisse, as-tu vu le prophète d'Allah, cet éprouvé ? Par Allah, je n'ai jamais vu un homme qui lui ressemble plus que toi, quand il était en bonne santé. Il dit : C'est moi.",
  },
  {
    id: 'ayyub-25',
    type: 'narrative',
    order: 25,
    content: "⟨وَكَانَ لَهُ أَنْدَرَانِ: أَنْدَرٌ لِلْقَمْحِ وَأَنْدَرٌ لِلشَّعِيرِ، فَبَعَثَ اللَّهُ سَحَابَتَيْنِ، فَلَمَّا كَانَتْ إِحْدَاهُمَا عَلَى أَنْدَرِ الْقَمْحِ أَفْرَغَتْ فِيهِ الذَّهَبَ حَتَّى فَاضَ، وَأَفْرَغَتِ الْأُخْرَى فِي أَنْدَرِ الشَّعِيرِ الْوَرِقَ حَتَّى فَاضَ⟩ He had two threshing floors, one for wheat and one for barley. Allah sent two clouds; when one was over the wheat floor it poured gold into it until it overflowed, and the other poured silver into the barley floor until it overflowed.",
    contentFr: "⟨وَكَانَ لَهُ أَنْدَرَانِ: أَنْدَرٌ لِلْقَمْحِ وَأَنْدَرٌ لِلشَّعِيرِ، فَبَعَثَ اللَّهُ سَحَابَتَيْنِ، فَلَمَّا كَانَتْ إِحْدَاهُمَا عَلَى أَنْدَرِ الْقَمْحِ أَفْرَغَتْ فِيهِ الذَّهَبَ حَتَّى فَاضَ، وَأَفْرَغَتِ الْأُخْرَى فِي أَنْدَرِ الشَّعِيرِ الْوَرِقَ حَتَّى فَاضَ⟩ Il avait deux aires de battage, une pour le blé et une pour l'orge. Allah envoya deux nuages ; quand l'un fut au-dessus de l'aire du blé, il y déversa de l'or jusqu'à ce qu'elle déborde, et l'autre déversa de l'argent dans l'aire de l'orge jusqu'à ce qu'elle déborde.",
  },
  {
    id: 'ayyub-26',
    type: 'narrative',
  ...
  },
  {
    ...
    type: 'narrative',
    order: 29,
    content: "⟨بَيْنَا أَيُّوبُ يَغْتَسِلُ عُرْيَانًا فَخَرَّ عَلَيْهِ جَرَادٌ مِنْ ذَهَبٍ، فَجَعَلَ أَيُّوبُ يَحْتَثِي فِي ثَوْبِهِ،⟩ While Ayyub was bathing, unclothed, locusts of gold fell upon him, and he began gathering them into his garment.",
    contentFr: "⟨بَيْنَا أَيُّوبُ يَغْتَسِلُ عُرْيَانًا فَخَرَّ عَلَيْهِ جَرَادٌ مِنْ ذَهَبٍ، فَجَعَلَ أَيُّوبُ يَحْتَثِي فِي ثَوْبِهِ،⟩ Tandis qu'Ayyoub se lavait, dévêtu, des sauterelles d'or tombèrent sur lui, et il se mit à les ramasser dans son vêtement.",
  },
  {
    id: 'ayyub-30',
    type: 'narrative',
    order: 30,
    content: "⟨فَنَادَاهُ رَبُّهُ: يَا أَيُّوبُ، أَلَمْ أَكُنْ أَغْنَيْتُكَ عَمَّا تَرَى؟ قَالَ: بَلَى وَعِزَّتِكَ، وَلَكِنْ لَا غِنَى بِي عَنْ بَرَكَتِكَ⟩ His Lord called to him: O Ayyub, had I not made you rich enough for what you see? He said: Yes, by Your might - but I cannot do without Your blessing.",
    contentFr: "⟨فَنَادَاهُ رَبُّهُ: يَا أَيُّوبُ، أَلَمْ أَكُنْ أَغْنَيْتُكَ عَمَّا تَرَى؟ قَالَ: بَلَى وَعِزَّتِكَ، وَلَكِنْ لَا غِنَى بِي عَنْ بَرَكَتِكَ⟩ Son Seigneur l'appela : Ô Ayyoub, ne t'ai-Je pas rendu assez riche pour te passer de ce que tu vois ? Il dit : Si, par Ta puissance - mais je ne peux me passer de Ta bénédiction.",
  },
